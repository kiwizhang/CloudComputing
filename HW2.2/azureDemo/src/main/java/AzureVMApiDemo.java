...
public class AzureVMApiDemo {
    ...
    public static Configuration createConfiguration() throws Exception {
      ...
      System.out.format("*** -> %s, %s, %s, %s, %s\n", basicURI, endpointURL, tenantID, applicationID, applicationKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        resourceGroupNameWithVhd = "15619";
        storageAccountName = "kiwizhang2";
        sourceVhdUri = String.format("https://%s.blob.core.windows.net/system/Microsoft.Compute/Images/vhds/%s", storageAccountName, "cc15619p22dcv6-osDisk.b0c453f3-f75f-4a2d-bd9c-ae055b830124.vhd");
        subscriptionId = "199180a1-588e-49c8-b6e2-d5993c6e71ac";
        tenantID = "c98a79ca-5a9a-4791-a243-f06afd67464d";
        applicationID = "5fcaf3b7-622b-4591-b7d1-8d2d5ab087e3";
        applicationKey = "painting";
